...
void main(void)
{
	...
	struct device *hts221 = device_get_binding("HTS221");
	struct device *lis3mdl = device_get_binding("LIS3MDL");
	struct device *lsm6ds0 = device_get_binding("LSM6DS0");
	struct device *lps25hb = device_get_binding("LPS25HB");
